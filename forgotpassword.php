...
<head>
  ...
  <title>GDS APPRAISAL APP | Need help accessing your account?</title>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                            <div class="mbr-header mbr-header--center mbr-header--std-padding">
                                <h2 class="mbr-header__text text-white">NEED HELP WITH YOUR ACCOUNT?</h2>
                                <p class="text-white" style="font-size:18px;">Type you email below and we will send you a link to reset your password.</p>
                            </div>
                            <div data-form-alert="true"></div>
                            <form action="#" method="post" data-form-title="LOGIN FORM">
                                <input type="hidden" value="#" data-form-email="true">
                                 <div class="form-group">
                                    <input type="email" class="form-control" name="email" required="" placeholder="Email" data-form-field="Email">
                                </div>
                                <div class="mbr-buttons mbr-buttons--right"><button type="submit" class="mbr-buttons__btn btn btn-lg btn-gds">SUBMIT</button></div>
                            </form>
                        </div>
                    </div>
                </div>
