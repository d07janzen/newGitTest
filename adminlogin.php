...
<head>
  ...
  <title>GDS APPRAISAL APP | Admin Login</title>
    ...
    <div class="mbr-navbar__section mbr-section">
        <div class="mbr-section__container container">
            <div class="mbr-navbar__container">
                ...
                <div class="mbr-navbar__column mbr-navbar__menu"> &nbsp; </div>
            </div>
        </div>
    </div>
</section>
...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background mbr-after-navbar" id="header1-73" style="background-image: url(assets/images/bigdata.jpg);">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                                <div class="mbr-header mbr-header--center mbr-header--std-padding">
                                    <h2 class="mbr-header__text text-white">GDS ADMINISTRATOR LOGIN</h2>
                                </div>
                                <div data-form-alert="true"></div>
                                <form method="post" data-form-title="LOGIN FORM">
                                    <input type="hidden" value="#" data-form-email="true">
                                    <?php 
                                      if (isset($error)) {
                                        echo '<p style="color:#fab6a6;" style="font-size:14px; font-family: \'Open Sans\', sans-serif;">'.$error.'.</p>';
                                      }
                                       ?>  
