...
<head>
  ...
  <title>GDS APPRAISAL APP | Account successfully registered</title>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
                                <div class="mbr-header mbr-header--center mbr-header--std-padding">
                                    <h2 class="mbr-header__text gdstitle text-white" style="font-weight:normal;">ACCOUNT SUCCESSFULLY REGISTERED</h2>
                                    <p class="text-white" style="font-size:14px; font-family: 'Open Sans', sans-serif;">We will review your application and send our response to your email.</p>
                                </div>
                            </div>
                        </div>
                    </div>
